<div class="p-3">
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <div class="relative mb-4 w-full">
            <button wire:click="toggleUserDropdown" class="flex items-center justify-between p-2.5 text-sm ih-medium ip-light  w-full border border-gray-300 rounded-md shadow-md b-light">
        ...
        <div class="p-3 border border-gray-200 rounded-md shadow-md">
            ...
            <div class="grid grid-cols-4 gap-4 items-center mb-5">
                <div class=" col-span-2">
                    <p class="font-bold"> {{ $visadores->name }}</p>
                    <p class=""> {{ $visadores->rut }}</p>


                </div>
                <div class=" col-span-2 text-center">
                    <button wire:click="destroy({{$visadores->id}})">
    ...
    <form wire:submit.prevent="save">
        ...
        <button class="text-sm p-3 border bg-blue-900 text-white font-bold" type="submit">Guardar Visador</button>
        <div wire:loading>
