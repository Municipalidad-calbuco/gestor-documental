@include('menu.menu')
<div class="p-4 lg:ml-64 bg-gray-100 h-full ">
    <div class="mt-14">
        ...
        <div class="border-b border-gray-200 bg-white">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content" data-tabs-active-classes="text-purple-600 hover:text-purple-600 border-purple-600" data-tabs-inactive-classes="dark:border-transparent text-gray-500 hover:text-gray-600 border-gray-100 hover:border-gray-300" role="tablist">
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="observacion-styled-tab" data-tabs-target="#styled-dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Observaciones</button>
                </li>
                <li class="me-2" role="presentation">
                        ...
                        <tbody>
                            <tr class="bg-white border-b">
                                <td scope="row" class="px-6 py-4 ">
                                    Resolucion fundada para licitación
                                </td>
                                <td class="px-6 py-4">
                                    Resolución
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <span class="bg-green-200 text-black text-xs font-medium me-2 px-2.5 py-0.5 rounded  ">Lista para la firma</span>
                                </td>
                                <td class="flex gap-3 px-6 py-4">
                                    <a href="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-writing">
                            ...
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4">
                                    <span class="bg-orange-300 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded  ">En espera</span>
                                </td>
                                <td class="px-6 py-4">
                            ...
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4">
                                    <span class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded  ">Pendiente de firma</span>
                                </td>
                                <td class="px-6 py-4">
    ...
    <div id="drawer-right-example" class="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-white w-80" tabindex="-1" aria-labelledby="drawer-right-label">
        ...
        <div class="p-4 md:p-5">
            <ol class="relative border-s-2 border-green-500  ms-3.5 ">
                <li class=" ms-8">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-green-500 rounded-full -start-3.5 ring-8 ring-white ">
                        <svg class="w-2.5 h-2.5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    ...
                    <h3 class="flex items-start mb-1 text-md font-semibold text-gray-900">Pablo Mauricio Oyarzo Kappes <span class="bg-green-500 text-white text-xs font-medium mr-2 px-2.5 py-0.5 rounded  ms-3">Finalizado</span></h3>
                    <time class="block mb-3 text-sm font-normal leading-none text-gray-500">Fecha: 25/06/2024</time>

                </li>

            </ol>
            <ol class="relative border-s-2 border-gray-400 ms-3.5 ">
                <li class=" ms-8">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-gray-400 rounded-full -start-3.5 ring-8 ring-white ">
                        <svg class="w-2.5 h-2.5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                            <path fill="currentColor" d="M6 1a1 1 0 0 0-2 0h2ZM4 4a1 1 0 0 0 2 0H4Zm7-3a1 1 0 1 0-2 0h2ZM9 4a1 1 0 1 0 2 0H9Zm7-3a1 1 0 1 0-2 0h2Zm-2 3a1 1 0 1 0 2 0h-2ZM1 6a1 1 0 0 0 0 2V6Zm18 2a1 1 0 1 0 0-2v2ZM5 11v-1H4v1h1Zm0 .01H4v1h1v-1Zm.01 0v1h1v-1h-1Zm0-.01h1v-1h-1v1ZM10 11v-1H9v1h1Zm0 .01H9v1h1v-1Zm.01 0v1h1v-1h-1Zm0-.01h1v-1h-1v1ZM10 15v-1H9v1h1Zm0 .01H9v1h1v-1Zm.01 0v1h1v-1h-1Zm0-.01h1v-1h-1v1ZM15 15v-1h-1v1h1Zm0 .01h-1v1h1v-1Zm.01 0v1h1v-1h-1Zm0-.01h1v-1h-1v1ZM15 11v-1h-1v1h1Zm0 .01h-1v1h1v-1Zm.01 0v1h1v-1h-1Zm0-.01h1v-1h-1v1ZM5 15v-1H4v1h1Zm0 .01H4v1h1v-1Zm.01 0v1h1v-1h-1Zm0-.01h1v-1h-1v1ZM2 4h16V2H2v2Zm16 0h2a2 2 0 0 0-2-2v2Zm0 0v14h2V4h-2Zm0 14v2a2 2 0 0 0 2-2h-2Zm0 0H2v2h16v-2ZM2 18H0a2 2 0 0 0 2 2v-2Zm0 0V4H0v14h2ZM2 4V2a2 2 0 0 0-2 2h2Zm2-3v3h2V1H4Zm5 0v3h2V1H9Zm5 0v3h2V1h-2ZM1 8h18V6H1v2Zm3 3v.01h2V11H4Zm1 1.01h.01v-2H5v2Zm1.01-1V11h-2v.01h2Zm-1-1.01H5v2h.01v-2ZM9 11v.01h2V11H9Zm1 1.01h.01v-2H10v2Zm1.01-1V11h-2v.01h2Zm-1-1.01H10v2h.01v-2ZM9 15v.01h2V15H9Zm1 1.01h.01v-2H10v2Zm1.01-1V15h-2v.01h2Zm-1-1.01H10v2h.01v-2ZM14 15v.01h2V15h-2Zm1 1.01h.01v-2H15v2Zm1.01-1V15h-2v.01h2Zm-1-1.01H15v2h.01v-2ZM14 11v.01h2V11h-2Zm1 1.01h.01v-2H15v2Zm1.01-1V11h-2v.01h2Zm-1-1.01H15v2h.01v-2ZM4 15v.01h2V15H4Zm1 1.01h.01v-2H5v2Zm1.01-1V15h-2v.01h2Zm-1-1.01H5v2h.01v-2Z" />
                        </svg>
                    </span>
